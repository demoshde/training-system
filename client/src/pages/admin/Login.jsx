...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    if (!username.trim()) {
      toast.error('Нэвтрэх нэрээ оруулна уу');
      return;
    }
    if (!password.trim()) {
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 py-6">
        ...
        {/* Title */}
        <h1 className="text-2xl font-bold text-gray-900 mb-1">Админ систем</h1>
        <p className="text-gray-500 text-sm mb-6">Нэвтрэх нэр, нууц үгээр нэвтрэх</p>
